 ...
 ******************************************************************************/
package ro.cs.cm.ws.client.audit;
...
import ro.cs.cm.ws.client.audit.entity.AuditEndpointExceptionBean;
import ro.cs.cm.ws.client.audit.entity.AuditEvent;
import ro.cs.cm.ws.client.audit.entity.AuditEventRequest;
import ro.cs.cm.ws.client.audit.entity.ObjectFactory;
...
public class AuditWebServiceClient extends WebServiceGatewaySupport {
	...
	public static AuditWebServiceClient getInstance(){
		return (AuditWebServiceClient) CMContext.getApplicationContext().getBean(auditWebServiceClientBean);
	}
	...
	public void addAuditEvent(AuditEvent auditEvent) throws BusinessException, XmlMappingException, IOException, WSClientException{
