...
public class OpenProjectDetailJob extends ApplicationObjectSupport implements Job {
			
	public void execute(JobExecutionContext jobCtx) throws JobExecutionException {
		logger.debug("OpenProjectDetailJob execute - START");
		...
		synchronized(entity) {
			...
			final File file = SerializeEntity.getInstance().createFile(IConstant.FILE_NAME_SERIALIZATION_FOR_OPEN_PROJECT_DETIALS);
		...
		logger.debug("OpenProjectDetailJob execute - END");
	}	
