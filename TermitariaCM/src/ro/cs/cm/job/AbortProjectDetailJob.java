...
public class AbortProjectDetailJob extends ApplicationObjectSupport implements Job {
...
final Exception[] exception = new Exception[1];
		...
		synchronized(entity) {
			...
			final File file = SerializeEntity.getInstance().createFile(IConstant.FILE_NAME_SERIALIZATION_FOR_ABORT_PROJECT_DETIALS);
