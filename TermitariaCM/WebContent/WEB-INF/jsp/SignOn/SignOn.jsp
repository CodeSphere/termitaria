...
<%@page import="ro.cs.cm.web.controller.root.ControllerUtils"%>
		...
		<div id="loginContent">
			...
			<form id="SIGNON_FORM" name="f" action="<c:url value='j_spring_security_check'/>" method="post">
				...
				<table id="loginTable">
							...
							<tr><td></td><td class="loginInput"><div style="align: right"><input type="submit" id="loginButton" value="<spring:message code="loginButtonLabel"/>"/></div></td></tr>	
		                </table>
		    	</form>
			</div> <!-- end MODULES_DIV -->
