...
public class ExpiredSessionFilter implements Filter{
	...
	static {
		...
		allowedUrls.put("/".concat(IConstant.APP_CONTEXT).concat("/Modules.htm"), new Object());
		allowedUrls.put("/".concat(IConstant.APP_CONTEXT).concat("/Main.htm"), new Object());
		allowedUrls.put("/".concat(IConstant.APP_CONTEXT).concat("/SignupWizard.htm"), new Object());
		allowedUrls.put("/".concat(IConstant.APP_CONTEXT).concat("/OrganisationVerifyNameUniqueness.htm"), new Object());
		allowedUrls.put("/".concat(IConstant.APP_CONTEXT).concat("/PersonVerifyUsernameUniqueness.htm"), new Object());
	...
	/**Response returned*/
	private static String RESPONSE = "<!-- session_redirect -->";
	...
	public void doFilter(ServletRequest req, ServletResponse res,
    	...
    	if ( allowedUrls.get(url) == null && 
    		...
    		logger.debug("\tRedirecting to Sign On Page x!");
    		logger.debug("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");
