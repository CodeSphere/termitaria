 ...
 *
 */
public class OrganisationOrganigramToPdfController extends RootAbstractController {

	
	public OrganisationOrganigramToPdfController() {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		OrganigramUtils.getInstance().createPDFOrganigram(response.getOutputStream(), tree);
