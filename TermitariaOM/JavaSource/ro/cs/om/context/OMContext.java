...
public class OMContext {
    ...
    /**
     * Organization Management Application Business Context
     */
	private static HashMap<String, Object> appContext = new HashMap<String, Object>();

	public static synchronized void storeOrganisationsTreesMapOnContext( String name, Object value){
	...
	public static synchronized Object getOrganisationsTreesMapFromContext(String name){
		return appContext.get(name);
	}
