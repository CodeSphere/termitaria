	...
	<script>
		...
		function init() {
			...
			if (!YAHOO.om.sessionExpired) {
				// The Loading panel
				YAHOO.om.sessionExpired = new YAHOO.widget.Panel(
						"SessionExpiredPanel", {
							width : "200px",
							fixedcenter : true,
							draggable : false,
				...
				YAHOO.om.sessionExpired
						.setBody('<spring:message code="session.expired"/> <img border=\"0\" src=\"images/ajaxLoader/ajax-loader-session-expired.gif\"/>');
