...
<%@page import="ro.cs.om.web.controller.root.ControllerUtils"%>
...
<!-- If the user is already authenticated, he must not see the SignOn Page -->
		...
		<div id="loginContent">
			...
			<form id="SIGNON_FORM" name="f" action="<c:url value='j_spring_security_check'/>" method="post">
				...
				<table id="loginTable">
							...
							<c:if test="${not empty param.login_error}">
								...
								<font color="red">
				        			<div>						        				
			        					...
			        					<c:if test="${EXCEPTION_CONSTANT.OM_USER_DISABLED == sessionScope.SPRING_SECURITY_LAST_EXCEPTION.message}">
			        						<spring:message code="unsuccessfullLoginAtemptMessage"/>
							...
							<tr><td></td><td class="loginInput"><div style="align: right"><input type="submit" id="loginButton" value="<spring:message code="loginButtonLabel"/>"/>
							<a href="/Termitaria/OM/SignupWizard.htm"><spring:message code="signupButtonLabel"/></a>
							</div></td>
							<td></td><td><div  style="align: left"></div></td>
							</tr>	
		                </table>
		    	</form>
			</div> <!-- end MODULES_DIV -->
