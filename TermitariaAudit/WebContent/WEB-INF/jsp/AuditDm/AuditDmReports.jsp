...
<span class="section_title"><img src="images/titles/Reports.jpg"><spring:message code="audit.dm.report"/></span>

<table>
<tr>	
	<td>
		<form:form id="reportForm" name="reportForm" commandName="auditDmReportCriteriaBean">
			...
			<table class="tableSearch" cellpadding="3" width="435px">
				...
				<tr>
					<td class="labelTdReportsForm">
						<spring:message code="audit.dm.reports.title" /><span id="required">*</span> 
					</td>
				...
				<tr>
					...
					<td style="padding-left: 1px">
						<table cellpadding="0">
							<tr>					
								<td>
									<form:input path="startDate" id="reportForm_startDate" readonly="true" cssClass="formField" tabindex="2" onclick="document.getElementById('startCalendar').style.zIndex = 1;instantiateStartEndCalendars('startCalendar','reportForm_startDate', '${TODAY_DATE}', 'startTime', true, 'auditDmStartReport', document.getElementById('reportForm_endDate').value, false, '1');"/>
								</td>
								<td>
				...
				<tr>			
					...
					<td>
						<form:input id="reportForm_message" path="message" cssClass="formField" tabindex="5"/>
					</td>
				</tr>	
				<tr>
					<td class="labelTdReportsForm">
				...
				<tr>
					<td class="labelTdReportsForm">
						<spring:message code="audit.dm.reports.orientation" />
					</td>
				...
				<tr>
					<td class="labelTdReportsForm">
						<spring:message code="audit.dm.reports.format" />
					</td>
				...
				<tr>
					<td colspan="2" class="formActions" align="right">			
						<input type="button" class="button" id="createAuditDmReport" value="<spring:message code="audit.dm.reports.create"/>" tabindex="${orientationTabIndex + 2}"
						onClick="manageOpenReport('AuditDmReports.htm', '${REPORT_SERVLET_URL}', 'reportForm', '<spring:message code='audit.dm.report'/>', 'reportForm_user', 'reportForm_personId', 'reportForm_startDate', 'reportForm_endDate', 'reportForm_message', 'reportForm_event', 'reportForm_moduleId', 'reportForm_title', 'reportForm_orientation', 'reportForm_format', 'reportForm_organisationId')"/>					
					</td>				
				</tr>
			</table>
