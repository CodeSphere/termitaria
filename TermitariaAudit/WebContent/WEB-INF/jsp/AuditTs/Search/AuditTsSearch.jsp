...
<span class="section_title"><img src="images/titles/Audit.jpg"><spring:message code="audit.ts"/></span>

<table>
<tr>
	<td>
<form:form commandName="searchAuditTsBean" id="searchForm">
...
<table class="tableSearch" >
	...
	<tr>
		...
		<td>
			<form:input path="startDate" id="auditSearchForm_startDate" readonly="true" cssClass="formFieldSearch" tabindex="2" onclick="document.getElementById('startCalendar').style.zIndex = 1;instantiateStartEndCalendars('startCalendar','auditSearchForm_startDate', '${TODAY_DATE}', 'startTime', true, 'auditTsStartSearch', document.getElementById('auditSearchForm_endDate').value, false, '1');"/>
		</td>
		<td>
		...
		<td class="labelTd">
			<spring:message code="audit.ts.results"/>
		</td>
		<td>
	...
	<tr>
		<td colspan="5"></td>
		<td>			
			<input type="button" class="button" id="searchAuditTs" value="<spring:message code="search"/>" tabindex="${searchButtonTabIndex}"/>			
		</td>				
	</tr>
</table>
...
<script type="text/javascript">
	...
	// -------------------------------SUBMIT SEARCH FORM---------------------------------------------------
	submitForm('AuditTsSearch.htm', 'searchForm', 'RESULTS');

	// ------------------------------- SEARCH AUDIT TS ----------------------------------------------------
	YAHOO.util.Event.addListener("searchAuditTs", "click", validateAndSubmitAuditSearchForm, { url : "AuditTsSearch.htm", formId : "searchForm", container : "RESULTS", userHiddenFormElementId: "personId", userInputAutoCompleteId: "auditSearchForm_user"}
				, true);
