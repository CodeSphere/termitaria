...
<span class="section_title"><img src="images/titles/Reports.jpg"><spring:message code="audit.cm.report"/></span>

<table>
<tr>	
	<td>
		<form:form id="reportForm" name="reportForm" commandName="auditCmReportCriteriaBean">
			...
			<table class="tableSearch" cellpadding="3" width="435px">
				...
				<tr>
					<td class="labelTdReportsForm">
						<spring:message code="audit.cm.reports.title" /> <span id="required">*</span> 
					</td>
				...
				<tr>
					...
					<td style="padding-left: 1px">
						<table cellpadding="0">
							<tr>					
								<td>
									<form:input path="startDate" id="reportForm_startDate" readonly="true" cssClass="formField" tabindex="2" onclick="document.getElementById('startCalendar').style.zIndex = 1;instantiateStartEndCalendars('startCalendar','reportForm_startDate', '${TODAY_DATE}', 'startTime', true, 'auditCmStartReport', document.getElementById('reportForm_endDate').value, false, '1');"/>
								</td>
								<td>
				...
				<tr>
					<td class="labelTdReportsForm">
						<spring:message code="audit.cm.reports.orientation" />
					</td>
				...
				<tr>
					<td class="labelTdReportsForm">
						<spring:message code="audit.cm.reports.format" />
					</td>
				...
				<tr>
					<td colspan="2" class="formActions" align="right">	
						<input type="button" class="button" id="createAuditCmReport" value="<spring:message code="audit.cm.reports.create"/>" tabindex="${orientationTabIndex + 2}"
							onClick="manageOpenReport('AuditCmReports.htm', '${REPORT_SERVLET_URL}', 'reportForm', '<spring:message code='audit.cm.report'/>', 'reportForm_user', 'reportForm_personId', 'reportForm_startDate', 'reportForm_endDate', 'reportForm_message', 'reportForm_event', 'reportForm_moduleId', 'reportForm_title', 'reportForm_orientation', 'reportForm_format', 'reportForm_organisationId')"/>				
					</td>				
				</tr>
			</table>
...
<script type="text/javascript">
	...
	// -------------------------------HOME MENU BUTTON----------------------------------------------------
	var getObject = new ObjSubmit("AuditCmSearch.htm", "", "MAIN_CONTENT");
