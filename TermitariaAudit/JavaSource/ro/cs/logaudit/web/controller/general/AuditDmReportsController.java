...
public class AuditDmReportsController extends RootAbstractController{

	private static final String VIEW = "AuditDmReports";
	...
	private static final String AUDIT_DM_REPORTS_SHOW_CRITERIA = "audit.dm.report.show.criteria";
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		try {
			...
			mav.addObject(MODULE_ID, IConstant.NOM_MODULE_DM_LABEL_KEY);
			...
			mav.addObject(IConstant.NOM_AUDIT_EVENTS_DM, AuditContext.getFromContext(IConstant.NOM_AUDIT_EVENTS_DM));
			...
			errorMessages.add(messageSource.getMessage(AUDIT_DM_REPORTS_SHOW_CRITERIA, new Object[] {}, RequestContextUtils.getLocale(request)));
		}
