...
import ro.cs.logaudit.ws.server.entity.AuditEndpointExceptionBean;
...
public class EndpointExceptionResolver extends SoapFaultMappingExceptionResolver{
	private final static String jaxb2MarshallerContextPath = "ro.cs.logaudit.ws.server.entity";
