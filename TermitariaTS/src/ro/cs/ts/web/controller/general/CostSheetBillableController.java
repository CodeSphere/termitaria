...
public class CostSheetBillableController extends RootAbstractController {
		
	//------------------------VIEW------------------------------------------------------------------
	private static final String VIEW 							= "CostSheetBillable";
	...
	public CostSheetBillableController() {
		setView(VIEW);		
	}
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(projectId > 0) {
			...
			if(project != null && (project.getManagerId() == userId || userAuth.hasAuthority(PermissionConstant.getInstance().getTS_CostSheetSearchAll()))) {
