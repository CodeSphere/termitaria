...
public class RecordBillableController extends RootAbstractController {
		
	//------------------------VIEW------------------------------------------------------------------
	private static final String VIEW 							= "RecordBillable";
	...
	public RecordBillableController() {
		setView(VIEW);		
	}
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(projectId > 0) {
			...
			if(project != null && (project.getManagerId() == userId || userAuth.hasAuthority(PermissionConstant.getInstance().getTS_RecordSearchAll()))) {
