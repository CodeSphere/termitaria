...
public class NamespacePrefixMapperImpl extends NamespacePrefixMapper{
	...
	private final static String cmServiceMessagesNamespaceUri = "http://localhost:8080/CM/services/schemas/messages";
	
	private final static String xsiPrefix = "xsi";
	private final static String cmServiceMessagesPrefix = "cm";
    ...
    public String getPreferredPrefix(String namespaceUri, String suggestion, boolean requirePrefix) {
        ...
        if (xsiNamespaceUri.equals(namespaceUri)) {
        	return xsiPrefix;
        } else if (cmServiceMessagesNamespaceUri.equals(namespaceUri)) {
        	return cmServiceMessagesPrefix;
        }
