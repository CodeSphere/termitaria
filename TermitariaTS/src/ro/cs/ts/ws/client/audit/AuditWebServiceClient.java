 ...
 ******************************************************************************/
package ro.cs.ts.ws.client.audit;
...
import ro.cs.ts.ws.client.audit.entity.AuditEndpointExceptionBean;
import ro.cs.ts.ws.client.audit.entity.AuditEvent;
import ro.cs.ts.ws.client.audit.entity.AuditEventRequest;
import ro.cs.ts.ws.client.audit.entity.ObjectFactory;
...
public class AuditWebServiceClient extends WebServiceGatewaySupport {
	...
	public static AuditWebServiceClient getInstance(){
		return (AuditWebServiceClient) TSContext.getApplicationContext().getBean(auditWebServiceClientBean);
	}
