...
public class Tools {
    ...
    /**
     * Casts an array of strings to Integer
     * @param stringArray
     * @return the Integer[] array or null if the stringArray is null 
     */
    public Integer[] castStringToIntegerArray (String[] stringArray){
