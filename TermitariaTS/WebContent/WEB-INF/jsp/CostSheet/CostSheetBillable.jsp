...
<td>
	<font class="labelTd"><spring:message code="costsheet.billable.yes" /></font>
		<input type="radio" name="billable" value="Y" tabindex="9" id="costSheetSearchForm_billable_yes"/> 	
	<font class="labelTd"><spring:message code="costsheet.billable.no" /></font>
		<input type="radio" name="billable" value="N" tabindex="10" id="costSheetSearchForm_billable_no"/> 				
</td>																							
