...
<c:if test="${IS_MANAGER_FOR_PROJECT}">
	...
	<td>
		<font class="labelTd"><spring:message code="record.billable.yes" /></font>
			<input type="radio" name="billable" value="Y" tabindex="9" id="recordSearchForm_billable_yes"/> 
		<font class="labelTd"><spring:message code="record.billable.no" /></font>
			<input type="radio" name="billable" value="N" tabindex="10" id="recordSearchForm_billable_no"/> 
	</td>																							
